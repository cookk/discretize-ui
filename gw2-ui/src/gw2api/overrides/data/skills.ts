...
> = {
  ...
  62789: {
    ...
    professions: ['Warrior'],
    description:
      'Spin and block enemy projectiles. Strikes all foes in melee range, then fires shots at foes out of melee range.',
  ...
  62885: {
    ...
    professions: ['Warrior'],
    description:
      'Lunge forward with explosive force, damaging enemies at your starting position.',
  ...
  41258: {
    ...
    icon: 'https://wiki.guildwars2.com/images/d/d3/Chapter_1-_Searing_Spell.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  40635: {
    ...
    icon: 'https://wiki.guildwars2.com/images/5/53/Chapter_2-_Igniting_Burst.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
    ...
    facts: [
      ...
      },
      {
        ...
        duration: 4,
        status: 'Weakness',
        description: '-50% Endurance Regeneration, 50% Fumble (Unrestricted)',
        apply_count: 1,
      },
      {
        text: 'Number of Targets',
  ...
  42449: {
    ...
    professions: ['Guardian'],
    description:
      'Call forth a heated vortex to collapse your enemies together.',
    icon: 'https://wiki.guildwars2.com/images/e/e7/Chapter_3-_Heated_Rebuke.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  40015: {
    ...
    icon: 'https://wiki.guildwars2.com/images/c/c9/Chapter_4-_Scorched_Aftermath.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  45022: {
    ...
    icon: 'https://wiki.guildwars2.com/images/f/fd/Chapter_1-_Desert_Bloom.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  40679: {
    ...
    icon: 'https://wiki.guildwars2.com/images/9/95/Chapter_2-_Radiant_Recovery.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  42008: {
    ...
    icon: 'https://wiki.guildwars2.com/images/1/16/Chapter_4-_Shining_River.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  42925: {
    ...
    icon: 'https://wiki.guildwars2.com/images/5/5f/Epilogue-_Eternal_Oasis.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
    ...
    facts: [
      ...
      },
      {
        ...
        icon: 'https://wiki.guildwars2.com/images/5/5f/Epilogue-_Eternal_Oasis.png',
        duration: 8,
        status: 'Eternal Oasis',
        description: '33% Heal Effectiveness',
      },
      {
  ...
  42986: {
    ...
    icon: 'https://wiki.guildwars2.com/images/3/30/Chapter_1-_Unflinching_Charge.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  41968: {
    ...
    icon: 'https://wiki.guildwars2.com/images/7/79/Chapter_2-_Daring_Challenge.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  41836: {
    ...
    icon: 'https://wiki.guildwars2.com/images/7/73/Chapter_3-_Valiant_Bulwark.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  40988: {
    ...
    icon: 'https://wiki.guildwars2.com/images/8/89/Chapter_4-_Stalwart_Stand.png',
    specialization: 62,
    type: 'Profession',
    categories: ['Tome'],
    weapon_type: 'None',
  ...
  63362: {
    ...
    icon: 'https://wiki.guildwars2.com/images/b/be/Haunt_Shot.png',
    specialization: 71,
    type: 'Profession',
    categories: ['Shroud'],
    weapon_type: 'None',
    ...
    facts: [
      ...
      {
        text: 'Tethered Ally Healing per Target',
        type: 'AttributeAdjust',
  ...
  63167: {
    ...
    icon: 'https://wiki.guildwars2.com/images/e/ef/Grasping_Shadows.png',
    specialization: 71,
    type: 'Profession',
    categories: ['Shroud'],
    weapon_type: 'None',
  ...
  63220: {
    ...
    icon: 'https://wiki.guildwars2.com/images/3/31/Dawn%27s_Repose.png',
    specialization: 71,
    type: 'Profession',
    categories: ['Shroud'],
    weapon_type: 'None',
    ...
    facts: [
      ...
      },
      {
        text: 'Apply Buff/Condition',
        type: 'Buff',
        icon: 'https://render.guildwars2.com/file/30307A6E766D74B6EB09EDA12A4A2DE50E4D76F4/102869.png',
        duration: 1,
        status: 'Fear',
        description: 'Involuntary retreat; unable to act; stacks duration.',
        apply_count: 1,
      },
      {
        text: 'Tethered Ally Healing per Target',
  ...
  63160: {
    ...
    icon: 'https://wiki.guildwars2.com/images/7/7b/Eternal_Night.png',
    specialization: 71,
    type: 'Profession',
    categories: ['Shroud'],
    weapon_type: 'None',
    ...
    facts: [
      ...
      },
      {
        ...
        status: 'Poisoned',
        description:
          'Deals damage every second; decreases healing effectiveness by 33%; damage stacks intensity.',
        apply_count: 2,
      },
      {
        text: 'Tethered Ally Healing per Target',
  ...
  63249: {
    ...
    icon: 'https://wiki.guildwars2.com/images/e/e6/Mind_Shock.png',
    specialization: 71,
    type: 'Profession',
    categories: ['Shroud'],
    weapon_type: 'None',
